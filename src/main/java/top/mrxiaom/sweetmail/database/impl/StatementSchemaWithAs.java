...
public class StatementSchemaWithAs implements IStatementSchema {
    public static final StatementSchemaWithAs INSTANCE = new StatementSchemaWithAs();
    private StatementSchemaWithAs() {}
